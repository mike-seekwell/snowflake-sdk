...
// 402001
codes.ERR_S3_NETWORK_COULD_NOT_CONNECT                     = 402001;
codes.ERR_S3_RESPONSE_FAILURE                              = 402002;

// 403001
codes.ERR_GLOGAL_CONFIGURE_INVALID_LOG_LEVEL               = 403001;
 ...
 *
 * @param {Number} errorCode the error code to use when building the error.
 * @param {Object} response the response sent by S3.
 *
 * @returns {Error}
 */
exports.createS3Error = function(errorCode, response)
{
  return createError(errorTypes.S3Error,
  {
    code     : errorCode,
    response : response
  });
...
/**
 * Determines if a given error is an S3Error.
 *
 * @param {Error} error
 *
 * @returns {Boolean}
 */
exports.isS3Error = function(error)
{
  return isErrorOfType(error, errorTypes.S3Error);
};
