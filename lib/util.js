...
exports.string =
{
   ...
   * function will return NaN, otherwise, it will return -1 if the first version
   * is smaller, 1 if the first version is bigger, and 0 if the two versions are
   * equal.
   *
...
exports.url =
{
  ...
  appendParam: function(url, paramName, paramValue)
  {
    ...
    if (urlAsObject)
    {
      // if the url already has query parameters, use '&' as the separator when
      // appending the additional query parameter, otherwise use '?'
