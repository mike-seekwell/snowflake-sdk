...
names.JS_DRIVER_ENABLE_COMPRESSION = 'JS_DRIVER_ENABLE_COMPRESSION';
...
[
  new Parameter(
  {
    ...
    'when communicating with non-Snowflake endpoints (e.g. S3).'
  }),
  new Parameter(
  {
    name  : names.JS_DRIVER_ENABLE_COMPRESSION,
    value : false,
    desc  : 'Whether to compress query payload in the JavaScript driver.'
  })
];
