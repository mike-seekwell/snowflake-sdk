...
var PARAM_RETRY_S3_MAX_NUM_RETRIES         = 's3RetryMaxNumRetries';
var PARAM_RETRY_S3_MAX_SLEEP_TIME          = 's3RetryMaxSleepTime';
...
function createParameters()
{
  ...
  return [
    ...
    {
      name         : PARAM_RETRY_S3_MAX_NUM_RETRIES,
      defaultValue : 2,
      validate     : isNonNegativeInteger
    },
    {
      name         : PARAM_RETRY_S3_MAX_SLEEP_TIME,
      defaultValue : 16,
      validate     : isNonNegativeInteger
    },
    {
...
ConnectionConfig.prototype.getRetryS3MaxNumRetries = function()
{
  return this._getParameterValue(PARAM_RETRY_S3_MAX_NUM_RETRIES);
};

ConnectionConfig.prototype.getRetryS3MaxSleepTime = function()
{
  return this._getParameterValue(PARAM_RETRY_S3_MAX_SLEEP_TIME);
};
