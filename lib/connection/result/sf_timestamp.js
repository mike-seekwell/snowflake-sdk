...
SfTimestamp.prototype.toSfDate = function()
{
  ...
  var momentAsObject = this.moment.toObject();
  var date = new Date(
      momentAsObject.years,
      momentAsObject.months,
      momentAsObject.date,
      momentAsObject.hours,
      momentAsObject.minutes,
      momentAsObject.seconds,
      momentAsObject.milliseconds);
